...
BUILTIN_STYLES: tuple[dict[str, Any], ...] = (
    ...
    {
        "id": f"{BUILTIN_PREFIX}highlighter",
        "name": "Acid Drop",
        "font_family": "work-sans",
        "font_weight": 900,
        "uppercase": True,
        "font_size_percent": 6.2,
        "letter_spacing": 0.035,
        "color": "#D8FF3E",
        "outline_color": "#0C0F08",
        "outline_width": 0.1,
        "shadow_color": "#FFFFFF",
        "shadow_offset": 0.035,
        "center_y": 24.0,
    ...
    {
        "id": f"{BUILTIN_PREFIX}candy",
        "name": "Bubblegum",
        "font_family": "nunito",
        "font_weight": 900,
        "font_size_percent": 6.3,
        "letter_spacing": 0.01,
        "color": "#FF69B4",
        "outline_color": "#3A0830",
        "outline_width": 0.1,
        "shadow_color": "#7CF9FF",
        "shadow_offset": 0.055,
        "center_y": 38.0,
    ...
    {
        "id": f"{BUILTIN_PREFIX}sunburst",
        "name": "Solar Flare",
        "font_family": "raleway",
        "font_weight": 900,
        "uppercase": True,
        "font_size_percent": 7.2,
        "letter_spacing": 0.025,
        "color": "#FFD84A",
        "outline_color": "#251044",
        "outline_width": 0.09,
        "shadow_color": "#FF3F81",
        "shadow_offset": 0.065,
        "center_y": 42.0,
    ...
    {
        "id": f"{BUILTIN_PREFIX}editorial",
        "name": "Front Page",
        "font_family": "barlow",
        "font_weight": 900,
        "font_size_percent": 5.6,
        "letter_spacing": -0.015,
        "color": "#FFF4DD",
        "align": "left",
        "outline_color": "#17243A",
        "outline_width": 0.065,
        "shadow_color": "#D92D3A",
        "shadow_offset": 0.045,
        "center_y": 58.0,
    ...
    {
        "id": f"{BUILTIN_PREFIX}cherry-bomb",
        "name": "Cherry Bomb",
        "font_family": "anton",
        "font_weight": 400,
        "uppercase": True,
        "font_size_percent": 6.8,
        "letter_spacing": 0.025,
        "color": "#FF4D5A",
        "outline_color": "#2B0710",
        "outline_width": 0.11,
        "shadow_color": "#FFD166",
        "shadow_offset": 0.055,
        "center_y": 30.0,
    ...
    {
        "id": f"{BUILTIN_PREFIX}ultraviolet",
        "name": "Ultraviolet",
        "font_family": "montserrat",
        "font_weight": 900,
        "uppercase": True,
        "font_size_percent": 5.8,
        "letter_spacing": 0.045,
        "color": "#D8C4FF",
        "outline_color": "#21094E",
        "outline_width": 0.095,
        "shadow_color": "#57F2CC",
        "shadow_offset": 0.06,
        "center_y": 42.0,
    ...
    {
        "id": f"{BUILTIN_PREFIX}velvet-rope",
        "name": "Velvet Rope",
        "font_family": "playfair-display",
        "font_weight": 900,
        "font_size_percent": 5.8,
    ...
    {
        "id": f"{BUILTIN_PREFIX}papaya-pop",
        "name": "Papaya Pop",
        "font_family": "poppins",
        "font_weight": 900,
        "font_size_percent": 6.0,
    ...
    {
        "id": f"{BUILTIN_PREFIX}moonlight",
        "name": "Moonlight",
        "font_family": "lato",
        "font_weight": 700,
        "font_size_percent": 4.7,
        "letter_spacing": 0.07,
        "color": "#F8FAFF",
        "align": "right",
        "outline_color": "#111B35",
        "outline_width": 0.075,
        "shadow_color": "#829BFF",
        "shadow_offset": 0.04,
        "center_y": 88.0,
    ...
    {
        "id": f"{BUILTIN_PREFIX}wildfire",
        "name": "Wildfire",
        "font_family": "oswald",
        "font_weight": 700,
        "uppercase": True,
        "font_size_percent": 6.6,
        "letter_spacing": 0.055,
        "color": "#FF7A18",
        "outline_color": "#3D0D08",
        "outline_width": 0.1,
        "shadow_color": "#FFD447",
        "shadow_offset": 0.06,
        "center_y": 48.0,
    ...
    {
        "id": f"{BUILTIN_PREFIX}fresh-cut",
        "name": "Fresh Cut",
        "font_family": "rubik",
        "font_weight": 900,
        "uppercase": True,
        "font_size_percent": 5.9,
        "letter_spacing": 0.035,
        "color": "#8CFFB0",
        "outline_color": "#06351D",
        "outline_width": 0.095,
        "shadow_color": "#FFFFFF",
        "shadow_offset": 0.045,
        "center_y": 22.0,
